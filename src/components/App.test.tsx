...
const mockContentful = new Map([
    ...
    [
        "skills-Design",
        {
            ...
            fields: {
                title: "Design",
                skills: ["Storybook", "Figma", "Photoshop"],
            },
        },
    ],
    [
                                            ...
                                            fields: {
                                                ...
                                                icon: {
                                                    ...
                                                    sys: {
                                                        ...
                                                        type: "Asset",
                                                        createdAt:
                                                            "2023-08-08T21:39:43.177Z",
                                                        updatedAt:
                                                            "2023-08-09T05:17:21.126Z",
                                                        environment: {
                                                            sys: {
                                                                id: "master",
                                                                type: "Link",
                                            ...
                                            fields: {
                                                ...
                                                icon: {
                                                    ...
                                                    sys: {
                                                        ...
                                                        type: "Asset",
                                                        createdAt:
                                                            "2023-08-08T21:41:49.829Z",
                                                        updatedAt:
                                                            "2023-08-09T05:17:38.418Z",
                                                        environment: {
                                                            sys: {
                                                                id: "master",
                                                                type: "Link",
...
it("renders Andrew Richardson with contentful data", () => {
    jest.spyOn(useContentful, "default").mockReturnValue({
        content: mockContentful as any,
    });
    render(
        <div>
            <App />
